...
@property (strong, nonatomic) NSString *awayInni01;
@property (strong, nonatomic) NSString *awayInni02;
@property (strong, nonatomic) NSString *awayInni03;
@property (strong, nonatomic) NSString *awayInni04;
@property (strong, nonatomic) NSString *awayInni05;
@property (strong, nonatomic) NSString *awayInni06;
@property (strong, nonatomic) NSString *awayInni07;
@property (strong, nonatomic) NSString *awayInni08;
@property (strong, nonatomic) NSString *awayInni09;
@property (strong, nonatomic) NSString *awayInniEx;
...
@property (strong, nonatomic) NSString *homeInni01;
@property (strong, nonatomic) NSString *homeInni02;
@property (strong, nonatomic) NSString *homeInni03;
@property (strong, nonatomic) NSString *homeInni04;
@property (strong, nonatomic) NSString *homeInni05;
@property (strong, nonatomic) NSString *homeInni06;
@property (strong, nonatomic) NSString *homeInni07;
@property (strong, nonatomic) NSString *homeInni08;
@property (strong, nonatomic) NSString *homeInni09;
@property (strong, nonatomic) NSString *homeInniEx;
